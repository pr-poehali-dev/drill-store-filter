...
const CATALOG_MENU = [
  ...
  },
  {
    ...
    sub: [
      { label: 'Широкого назначения', sub: [] },
      { label: 'Титан и жаропрочные материалы', sub: [] },
      { label: 'Фрезы с переменным углом для P, M, K', sub: [] },
      { label: 'Для алюминия', sub: [] },
      { label: 'Для нержавеющих сталей', sub: [] },
      { label: 'Для черновой обработки', sub: [] },
      { label: 'Фасочные фрезы', sub: [] },
      { label: 'Конусные фрезы', sub: [] },
    ],
  },
  {
    label: 'Расточные системы',
    sub: [
      { label: 'Набор расточных систем', sub: [] },
      { label: 'Оправки для расточных систем', sub: [] },
      { label: 'Расточные головки', sub: [] },
      { label: 'Комплектующие', sub: [] },
      { label: 'Удлинители', sub: [] },
    ],
  },
  {
  ...
  },
  {
    ...
    sub: [
      { label: 'Формирование зуба', sub: [] },
      { label: 'Развёртки', sub: [] },
      { label: 'Специальные твердосплавные фрезы', sub: [] },
    ],
  },
  {
